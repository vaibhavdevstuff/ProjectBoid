...
namespace ProjectBoid.Data
{
    ...
    {
        [field: Header("Unit Data")] [field: SerializeField] public float MaxSpeed { get; private set; } = 8f;
        ...
        public int RayViewDirectionCount { get; private set; } = 200;
        ...
        [field: Header("Spawn Data")] [field: SerializeField] public BoidUnit BoidUnit { get; private set; }
